      ...
      <section className={styles.latesEpisodes}>
        ...
        <ul>
          {latesEpisodes.map((episode, index) => {
            return (
              // no key é o primeiro do map, e retornamos a informação única de cada objeto, nesse caso o ID
              //a TAG IMAGE do next : Ele recuz o tamanho com a tag Image e os tamanhos é o tamanho do retorno
              <li key={episode.id}> 
                <Image 
                  width={192} 
                  height={192} 
...
// versão estatica para que quando a primeira pessoa acessar gere uma página estática que outros verão
